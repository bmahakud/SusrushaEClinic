...
ALLOWED_HOSTS = ['.hellotoppers.com','128.199.17.132','localhost','127.0.0.1']


#BASE_URL = "http://127.0.0.1:8000"# development
BASE_URL ="https://hellotoppers.com" #production
...
REST_FRAMEWORK = {
 ...
 # ),
  ...
  #      'rest_framework.renderers.TemplateHTMLRenderer',  # Include only the renderers you need.
  # ],
  ...
  # 'BROWSABLE_API_TEMPLATES': {
  #  'accountAPIs.views.PaymentStatusView': 'accountAPIs/endpoint1_template.html',
  # },
...
CORS_ALLOWED_ORIGINS = [
        'http://localhost:3000','https://google.com','https://api.phonepe.com','https://mercury-uat.phonepe.com','https://hellotoppers.com'
]
